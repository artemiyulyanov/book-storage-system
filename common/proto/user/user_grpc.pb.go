...
type UserServiceClient interface {
	...
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserCreatedResponse, error)
}
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserCreatedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	CreateUser(context.Context, *CreateUserRequest) (*UserCreatedResponse, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserRequest) (*UserCreatedResponse, error) {
